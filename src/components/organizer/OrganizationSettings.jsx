...
export default function OrganizationSettings({organizer,organization}) {
...
console.log(organization);
  ...
  return (
    ...
    {/* navbar */}
      <header className=" z-40 w-full border-b border-slate-800 bg-slate-900/80 backdrop-blur-md px-4 sm:px-6 py-[12.5px]">
